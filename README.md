...
- **R4 — Sunburst 2.0: DiskUsage visual identity is in progress.** R4.1 derived segment model, R4.2 visual language, and R4.3 interaction are complete; the next slice is R4.4 — Small-segment handling. See [`docs/ROADMAP.md`](docs/ROADMAP.md).
